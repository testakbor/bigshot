			...
			<div class="row">
              ...
              <div class="card">
                ...
                @csrf
                    ...
                    <button style="width:100%; background: #2450AF;color:#ffffff;" class="btn btn-success"><img src="https://img.icons8.com/fluent/48/000000/facebook-new.png" width="40" height="30"> Facebook</button>
                    <button style="margin-top:5px; width:100%; background: #e7e7e7;color:#000000;" class="btn btn-success"><img src="https://img.icons8.com/color/48/000000/google-logo.png" width="40" height="30"> Google </button>
