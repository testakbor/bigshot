                  ...
                  <div class="tab-pane fade" id="return" role="tabpanel">
                    <div class="col-sm-12">
                      <form method="POST" action="{{route('genarelQuiry')}}">
                        ...
                        <div class="form-group">
                          <div class="col-sm-8">
                            <input class="form-control" type="text" name="" placeholder="Oder id or invoice number" readonly>
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <textarea class="form-control" type="text" name="" ng-model="me.email" placeholder="Reason for Cancellation">
                          </textarea>
                          </div>
                        </div>
                        ...
                        <div class="red box">
                          ...
                          <div class="form-group">
                            <label class="col-sm-4 control-label">Email</label>
                            <div class="col-sm-8">
                              <input class="form-control" type="text" name="email" ng-model="me.email" placeholder="Email">
                            </div>
                          </div>

                          <div class="form-group">
                            <div class="col-sm-8">
                              <input class="form-control" type="text" name="" ng-model="me.email" placeholder="Oder id or invoice number" readonly>
                            </div>
                          </div>
                          <div class="form-group">
                            <div class="col-sm-8">
                              <input class="form-control" type="text" name="" ng-model="me.email" placeholder="SKU or Product code">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-sm-4 control-label">
