...
<div class="wrapper d-flex align-items-stretch">
    <nav id="sidebar" class="active">
        ...
        <li>
          <a isemphasized="0" isinsidemenubarshowv2="0" class="SideTabBar__SideTabItem-sc-18isgdb-0-Component gaHUxX" href="#"><svg viewBox="0 0 13 15" xmlns="http://www.w3.org/2000/svg" style="width: 100%; height: 25px; margin-top: 12px;"><path d="M6.5 0C10.09 0 13 2.82 13 6.298a6.052 6.052 0 0 1-1.904 4.411l.001.001L6.5 15l-4.28-4.009C.86 9.859 0 8.188 0 6.298 0 2.82 2.91 0 6.5 0zm0 4.618c-.957 0-1.733.752-1.733 1.68 0 .927.776 1.679 1.733 1.679.957 0 1.733-.752 1.733-1.68 0-.927-.776-1.679-1.733-1.679z" fill="#2eaa77"></path></svg><div class="SideTabBar__SideTabTitle-sc-18isgdb-1 jyOheE">Local</div></a>
      </li>
      <li>
    ...
    <li>
        <a isemphasized="0" isinsidemenubarshowv2="0" class="SideTabBar__SideTabItem-sc-18isgdb-0-Component gaHUxX" href="#"><svg viewBox="0 0 22 22" style="width: 100%; height: 25px; margin-top: 12px;"><g fill="none" fill-rule="evenodd"><circle fill="#0098D3" fill-rule="nonzero" cx="11" cy="11" r="11"></circle><path d="M11 20.5a9.5 9.5 0 1 0 0-19 9.5 9.5 0 0 0 0 19z" fill="#DBF3FC" fill-rule="nonzero"></path><path d="M11 1.5v9.445l6.745 6.745A9.5 9.5 0 1 1 11 1.5z" fill="#FFF" fill-rule="nonzero"></path><path stroke="#0098D3" stroke-width="1.54" stroke-linecap="round" stroke-linejoin="round" d="M14.818 14.663L11 11.018v-6.39"></path></g></svg><div class="SideTabBar__SideTabTitle-sc-18isgdb-1 jyOheE">Recent</div></a>
    </li>
    <li>
