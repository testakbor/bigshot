      ...
      <nav id="sidebar" class="active">
        ...
        <ul class="list-unstyled components mb-5">
          ...
          <li>
              ...
              <a isemphasized="0" isinsidemenubarshowv2="0" class="SideTabBar__SideTabItem-sc-18isgdb-0-Component gaHUxX" href="/feed/pickup__tab"><svg viewBox="0 0 13 15" xmlns="http://www.w3.org/2000/svg" style="width: 100%; height: 25px; margin-top: 12px;"><path d="M6.5 0C10.09 0 13 2.82 13 6.298a6.052 6.052 0 0 1-1.904 4.411l.001.001L6.5 15l-4.28-4.009C.86 9.859 0 8.188 0 6.298 0 2.82 2.91 0 6.5 0zm0 4.618c-.957 0-1.733.752-1.733 1.68 0 .927.776 1.679 1.733 1.679.957 0 1.733-.752 1.733-1.68 0-.927-.776-1.679-1.733-1.679z" fill="#2eaa77"></path></svg><div class="SideTabBar__SideTabTitle-sc-18isgdb-1 jyOheE">Local</div></a>
          </li>
          <li>
            <!-- <a href="#"><span class="fa fa-sticky-note"></span> Blog</a> -->
            <a isemphasized="0" isinsidemenubarshowv2="0" class="SideTabBar__SideTabItem-sc-18isgdb-0-Component gaHUxX" href="/feed/blitz_buy__tab"><svg viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg" style="width: 100%; height: 25px; margin-top: 12px;"><g fill="none" fill-rule="evenodd"><g><circle fill="#C0952B" cx="10.952" cy="10.952" r="10.952"></circle><path d="M10.917 11.067l-.004.003L2.79 6.347a9.413 9.413 0 0 1 8.15-4.722l-.023 9.442z" fill="#F9D798"></path><path d="M10.918 11.067l.022-9.441A9.344 9.344 0 0 1 15.666 2.9a9.4 9.4 0 0 1 3.424 3.43l-8.172 4.736z" fill="#F1BE40"></path><path d="M19.097 15.83l-8.179-4.757v-.006l8.172-4.735a9.493 9.493 0 0 1 .007 9.498" fill="#F7D48E"></path><path d="M10.91 11.074v-.006L2.789 6.345a9.493 9.493 0 0 0-.02 9.449l8.143-4.72z" fill="#F5C24F"></path><path d="M10.91 11.074l-8.142 4.72a9.391 9.391 0 0 0 3.453 3.48 9.352 9.352 0 0 0 4.667 1.276l.022-9.476z" fill="#F9D798"></path><path d="M19.096 15.828l-8.18-4.757-.006.003-.022 9.476a9.41 9.41 0 0 0 8.208-4.722" fill="#F1BE40"></path></g><path d="M11 13.463a2.4 2.4 0 0 0 2.4-2.4c0-.884-.8-2.025-2.4-3.423-1.6 1.398-2.4 2.539-2.4 3.423a2.4 2.4 0 0 0 2.4 2.4z" fill="#FFF"></path><path d="M-1-1h24v24H-1z"></path></g></svg><div class="SideTabBar__SideTabTitle-sc-18isgdb-1 jyOheE">Blitz Buy</div></a>
          </li>
          <li>
            <!-- <a href="#"><span class="fa fa-cogs"></span> Services</a> -->
            <a isemphasized="0" isinsidemenubarshowv2="0" class="SideTabBar__SideTabItem-sc-18isgdb-0-Component gaHUxX" href="/feed/recently_viewed__tab"><svg viewBox="0 0 22 22" style="width: 100%; height: 25px; margin-top: 12px;"><g fill="none" fill-rule="evenodd"><circle fill="#0098D3" fill-rule="nonzero" cx="11" cy="11" r="11"></circle><path d="M11 20.5a9.5 9.5 0 1 0 0-19 9.5 9.5 0 0 0 0 19z" fill="#DBF3FC" fill-rule="nonzero"></path><path d="M11 1.5v9.445l6.745 6.745A9.5 9.5 0 1 1 11 1.5z" fill="#FFF" fill-rule="nonzero"></path><path stroke="#0098D3" stroke-width="1.54" stroke-linecap="round" stroke-linejoin="round" d="M14.818 14.663L11 11.018v-6.39"></path></g></svg><div class="SideTabBar__SideTabTitle-sc-18isgdb-1 jyOheE">Recent</div></a>
          </li>
          <li>
          ...
          <div class="col-md-12">
            <div class="container">
              <div  style="background: aliceblue;">
                <h4 class="text-center mt-2">YOUR BALANCE</h4>
                <h2 class="text-center mt-2">100 points</h2>
                <p class="text-center">100 lifetime points since Jul 2020</p>
              </div>
              <div>
                <section>
                  <h2>Turn points into Reward Discounts</h2>
                  <div class="row py-5">
                    ...
                    <div class="card" style="width: 18rem;">
						  ...
						  <div class="card-demo">
						  	<p class="mt-2 ml-2 text-white">ENTIRE PURCHASE</p>
						  	<h1 class="mt-2 ml-2 text-white">5% OFF</h1>
						  </div>
						  <div class="card-body">
						    <p class="card-text">
						    	<button type="button" class="btn btn-light mr-5">Redeem</button>
						    	200 Points
						    </p>
						  </div>
					</div>
