				...
				<a isemphasized="0" isinsidemenubarshowv2="0" class="" href="{{url('/recent')}}">
					<svg viewBox="0 0 22 22" style="width: 100%; height: 25px; margin-top: 12px;">
						<g fill="none" fill-rule="evenodd">
							...
							<path d="M11 20.5a9.5 9.5 0 1 0 0-19 9.5 9.5 0 0 0 0 19z" fill="#DBF3FC" fill-rule="nonzero"></path>
							<path d="M11 1.5v9.445l6.745 6.745A9.5 9.5 0 1 1 11 1.5z" fill="#FFF" fill-rule="nonzero"></path>
							<path stroke="#0098D3" stroke-width="1.54" stroke-linecap="round" stroke-linejoin="round" d="M14.818 14.663L11 11.018v-6.39"></path>
						</g>
					</svg>
				...
				<a isemphasized="0" isinsidemenubarshowv2="0" class="{{'brands' == request()->path()? 'active' : ''}}" href="{{url('/brands')}}">
					<svg viewBox="0 0 24 24" style="width: 100%; height: 28px; margin-top: 12px;">
						<g id="Icons/18/ic_brand_shield_18" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
							<g>
								<rect id="Rectangle" x="0" y="0" width="23.4" height="23.4"></rect>
								<g id="Brand-sheild_18" transform="translate(1.600000, 1.600000)">
									<g id="Geen-Shield">
										<path d="M-5.32907052e-15,4.60986842 C2.27808404,3.08888308 6.58459094,1.37356911 10.5368421,0 C13.572825,1.19653322 17.4129136,2.43182498 21.0736842,4.60986842 C21.0736842,7.90263158 20.1782317,11.4844418 19.7565789,13.1710526 C18.8785088,16.6833333 15.8052632,19.3175439 10.5368421,21.0736842 C5.26842105,19.3175439 2.19517544,16.6833333 1.31710526,13.1710526 C0.893406177,11.4762563 -5.32907052e-15,7.90263158 -5.32907052e-15,4.60986842 Z" id="Path-4-Copy-7" fill="#65BD37"></path>
										<path d="M15.9383044,7.13117972 C15.6466105,6.78339725 15.1282126,6.73792842 14.7804301,7.02962224 C14.7597268,7.04698661 14.7398924,7.06536142 14.7209993,7.08467971 L9.08978918,12.8426019 L9.08978918,12.8426019 L6.45570184,10.1438387 C6.10983825,9.78948304 5.54219836,9.78259881 5.18784265,10.1284624 C5.18078715,10.1353488 5.17384572,10.1423511 5.16702119,10.1494665 C4.80867009,10.5230898 4.80911084,11.1129569 5.16801987,11.4860442 L8.62100984,15.0754405 C8.86988722,15.3341495 9.28136728,15.3421196 9.54007627,15.0932422 C9.54623951,15.0873132 9.55228514,15.0812631 9.55820962,15.0750955 L15.8928254,8.48052725 C16.2503312,8.10835058 16.2699393,7.52658345 15.9383044,7.13117972 Z" id="Fill-1-Copy-2" fill="#FFFFFF"></path>
									</g>
								</g>
							</g>
						</g>
					</svg>
					<div class="SideTabBar__SideTabTitle-sc-18isgdb-1 jyOheE">Brands</div>
				</a>
			</li>
			<li>
				<ul class="menus">
					<li>
						<a isemphasized="0" isinsidemenubarshowv2="0" class="SideTabBar__SideTabItem-sc-18isgdb-0-Component gaHUxX" href="#">
							<svg viewBox="0 0 24 24" style="width: 100%; height: 25px; margin-top: 12px;">
								<g id="Icons/Main/ic_grid_24" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
									<g id="Group-14-Copy">
										<rect id="Rectangle-4" x="0" y="0" width="24" height="24"></rect>
										<g id="Group" transform="translate(2.000000, 2.000000)" fill="#79D6FA" stroke="#006BA0" stroke-width="1.4">
							...
							<div class="SideTabBar__SideTabTitle-sc-18isgdb-1 jyOheE">Categories</div>
						</a>
						<div class="megadrop">
							<div class="col">
                        ...
                        @foreach($categories as $value)
									<li>
										<a href="{{route('category.product',base64_encode($value->term_taxonomy_id))}}">
											<table>
												<tr>
