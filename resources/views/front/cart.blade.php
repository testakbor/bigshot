        ...
        <div class="col-md-12 ">
            <div class="container-fluid mt-2">
                 ...
                 <div class="row">
                  <div class="col-md-8">
                      ...
                      <nav id="myTab" class="nav nav-tabs nav-justified"><a class="nav-item nav-link active"
                                    ...
                                    data-toggle="tab" href="#menu2">REVIEW ORDER</a>
                                       <a class="nav-item nav-link"
                                    data-toggle="tab" href="#menu1">PAYMENT</a>
                               ...
                               <div id="home" class="tab-pane active">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="lastName" value="{{$l_name}}"
                                 ...
                                 <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="address" value="{{$address1}}"
                                        name="address_one" placeholder="Address">
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-6 mb-3">
                                 ...
                                 <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" value="Bangladesh" name="country"
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        ->first();
                                        @endphp
                                        <input type="text" class="form-control" value="{{$posts_codes->zip}}" name="zip"
                                ...
                                <div id="menu1" class="tab-pane fade">
                                      <h5 style="background: #e7e7e7;padding:10px 4px;"><b>CHOSE PAYMENT OPTION</b></h5>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                      @php $image=DB::table('postmeta')->where(['post_id'=>$item->id,'meta_key'=>'attached_file'])->select('meta_value')->first(); @endphp  
                                                       <img  width="100px" height="100px" src="{{asset('backend/products/'.$image->meta_value)}}"
                                                        ...
                                                        <form class="up"  method="POST" action="{{route('cart.update')}}"
                                                            ...
                                                            <div class="quantity buttons_added" style="padding: 0;">
                                                                ...
                                                                <input type="number" id=""
                                                                    class="input-text quantity_text" step="1" min="1"
                                                                    max="" name="quantity" value="{{$item->quantity}}"
                                                                    title="quantity" size="4" inputmode="numeric">
                                                                <!-- <input type="button" value="+" class="plus"> -->
                                                                <!-- <input type="submit" value="" class="plus"> -->
                                                                <button type="submit" id="car_update"
              ...
              @else 
                 ...
                 <div class="text-center"><a href="{{url('/')}}"><span style="color:orange;fornt-size:14px;">SHOP NOW</span></a></div> 
             @endif 
