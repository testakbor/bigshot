...
<div id="content" class="p-4 p-md-5">
    <div class="row">
        ...
        <article class="card ml-5">
       		<h3 class="ml-3 mt-3"><b>PRIVACY POLICIES</b></h3>
       		<h5 class="ml-3"><b>INFORMATION COLLECTION</b></h5>
       		<p class="ml-3">Unless you are a registered member of our website and/or loyalty program, we do not collect personal information whilst you are only browsing this site.</p>
       		...
       		<h3 class="ml-3"><b>DATA SECURITY</b></h3>
       		<p class="ml-3">When you make a payment for a purchase via our website, you are doing so directly with our payment provider via a secure connection. We do not record credit card numbers and at no time are your card details handled in our system. Individuals who choose to join our member club, complete online forms or lodge enquiries will have their details stored on password protected databases. Staff members associated with website maintenance have access to our website’s backend system which is password protected. Our website server is also password protected.</p>
       		<h3 class="ml-3"><b>ACCESS AND CORRECTION</b></h3>
       		<p class="ml-3">The personal information we maintain is available for viewing and modification in the account settings section of the website.</p>
       		<h3 class="ml-3"><b>CONTACT US</b></h3>
       		<p class="ml-3">If you have any concerns about this privacy policy, or the personal information we have collected about you, or any complaints about how we have handled your personal information please contact us </p>
