                  ...
                  <tbody>
                   ...
                   @foreach($brands as $value)
                    <tr>
                      ...
                      <td>
                        @if($value->meta_value)
                        <img src="{{asset('assets/admin/brand/'.$value->meta_value)}}" style="height: 50px;width:50px" alt=""> 
                        @else 
                      ...
                      <td>
                        <a href="{{route('brand.edit',$value->term_id)}}" class="btn btn-primary"> <i class="fa fa-edit"></i> Edit</a>
                      </td>
                    </tr>
                    @php 
                    $i++;
