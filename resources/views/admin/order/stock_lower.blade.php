        ...
        <div class="card-body">
          ...
          <div class="table-responsive-sm">
            <table class="table table-striped">
              ...
              <tbody>
                @php $cost=0; $alert=0; $qty=0; $i=0; $price=0; $sprice=0; $sku=''; $total_sell_price=0; $total_cost=0;$status=''; @endphp
