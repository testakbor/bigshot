            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="right">
                    <a onclick="return confirm('Do you want to delivery?')" href="{{route('order.dispatch.delivered',$orders->ID)}}" class="btn btn-success">Copy</a><br>
                    <a href="{{route('order.dispatch.edit',$orders->ID)}}"  class="btn btn-primary mt-1" style=" width: 49%;">Complete</a>
                  </td>
