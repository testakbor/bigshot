  ...
  <section class="content-header">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Lower Stock weekly</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
    <div class="s002">
      <form method="post" action="{{route('stock.sku.search.lower')}}">
        @csrf
        <fieldset>
          <legend>Lower Stock List weekly</legend>
        </fieldset>
        ...
        <div class="card-body">
          <div class="table-responsive-sm">
            <table class="table table-striped">
              ...
              <tbody>
                @php $qty=0; $low_stock_qty=0; $i=0; $price=0; $sprice=0; $sku=''; $total_sell_price=0; $total_cost=0; $cost=0; @endphp
                ...
                @php $low_stock_qty=$info->meta_value; @endphp
                @endif
                ...
                @endforeach
                 ...
                 @php 
                            ...
                            @endphp
                                ...
                                @if($diff<=7)
                                    @if($qty<=$low_stock_qty) @php $i++ @endphp 
                   <tr>
