  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="{{route('admin.home')}}" class="brand-link text-center">
        <img src="{{asset('assets/common/images/logo.png')}}" alt="Bigshot Logo" class=" img-circle elevation-3" style="opacity: .8;height: 60px;width: 100px;">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{route('product.index')}}" class="nav-link {{isset($page) && $page=='product'?'active':''}}">
