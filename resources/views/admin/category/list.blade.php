                ...
                <div class="form-group">
                        ...
                        <div class="">
                          <div class="custom-control custom-checkbox">
                            <input name="manageTrem" type="checkbox" {{$category->term_group==0?'checked':''}} id="manageTrem" class="custom-control-input">
                            <label for="manageTrem" class="custom-control-label"> Trem Group</label>
                          </div>
                        </div>
                      </div>
                      ...
                      @endif
                        <label for="term_group_level">Term Group</label>
                        <select name="term_group" class="form-control" id="">
                        @foreach($term_groups as $trg)
                        <option {{$category->term_group==$trg->term_id?'seleted':''}} value="{{$trg->term_id}}">{{$trg->name}}</option>
                        @endforeach
                        </select>
                      </div>   
                  ...
                  <form role="form" method="POST" action="{{route('category.store')}}" >
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group ">
                        ...
                        <div class="">
                          <div class="custom-control custom-checkbox">
                            <input name="manageTrem" type="checkbox" checked id="manageTrem" class="custom-control-input">
                            <label for="manageTrem" class="custom-control-label"> Trem Group</label>
                          </div>
                        </div>
                      </div>
