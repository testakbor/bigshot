				...
				<div class="col-md-5">
					<div class="card card-primary">
                      ...
                      <form role="form" method="POST" action="{{route('district.update',['id' => $dist_name->term_id])}}"> 
                       ...
                       <form role="form" method="POST" action="{{route('district.thana.postcode.update',['thana_id'=>$thana->term_id])}} ">
							...
							<div class="card-body">
                                  ...
                                  <div class="form-group">
									  <label for="categoryName">Thana</label>
									   <input type="text" name="thana" value="{{$thana->name}}" class="form-control" required autocomplete="off" placeholder="Enter Thana Name">
									</div>
                                    <div class="form-group">
									  <label for="categoryName">Post Code</label>
									   <input type="text" name="postcode" value="{{$postcode->description}}" class="form-control" required autocomplete="off" placeholder="Enter Post Code">
									</div>
                                </div>
								<!-- /.card-body -->
								<div class="card-footer">
