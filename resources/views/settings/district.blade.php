			...
			<div class="row">
				<div class="col-md-5">
					<div class="card card-primary">
                      ...
                      <form role="form" method="POST" action="{{route('district.store')}}" enctype="multipart/form-data"> 
		                	@csrf 
							<div class="card-body">
								...
								<table class="table table-bordered table-striped">
									...
									<tbody>
									  ...
									  @foreach($district as $key=>$districts) 
										<tr>
                                            <td>{{++$key}}</td>
											<td>{{$districts->district}} <a class="btn btn-success btn-sm" href="{{route('district.edit',$districts->term_id)}}">Edit</a></td>
											<td>
